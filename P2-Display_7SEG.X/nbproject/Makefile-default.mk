...
SOURCEFILES_QUOTED_IF_SPACED=Display_7SEG.s

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/Display_7SEG.o
POSSIBLE_DEPFILES=${OBJECTDIR}/Display_7SEG.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/Display_7SEG.o

# Source Files
SOURCEFILES=Display_7SEG.s
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/Display_7SEG.o: Display_7SEG.s  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/Display_7SEG.o 
	${MP_AS} -mcpu=PIC18F57Q84 -c \
	-o ${OBJECTDIR}/Display_7SEG.o \
	Display_7SEG.s \
